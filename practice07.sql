...
select 
    ...
    DECODE( SUBSTR(jumin, 7, 1) , 1, '남자', 2, '여자', 3, '남자', 4, '여자' ) 성별
from student
where deptno1 = 101;

5.
Student 테이블에서 1 전공이 (deptno1) 101번인
학생의 이름과 연락처와 지역을 출력하세요.
단,지역번호가 02 는 "SEOUL" ,
031 은 "GYEONGGI" , 
051 은 "BUSAN" , 
052 는 "ULSAN" , 
...
select name, tel,
    ...
    --DECODE(SUBSTR(tel, 1, 3), '02)', '서울', 031, '경기', 051, '부산', 052, '울산', 055, '경남', '기타지역') 지역명
from student
where deptno1 = 101;